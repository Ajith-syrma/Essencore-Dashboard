    ...
    public class DataManagement
    {
            ...
            try
            {
                using (SqlConnection sqltranscon = new SqlConnection(ConnectionString))
                {
                    using (SqlCommand sqlcmdtrans = new SqlCommand("pro_InsertHoneywellDashboard_Transaction", sqltranscon))
                    {
                        ...
                        sqlcmdtrans.Parameters.AddWithValue("@Createid", data.Createid.ToString());
                        sqlcmdtrans.Parameters.AddWithValue("@Updateid", data.Updateid.ToString());
                        sqltranscon.Open();
        ...
        public List<Dashboard_HourlyOP> gethourlyone(Dashboard_HourlyOP dashboard_HourlyOP)
        {
            ...
            try
            {
                ...
                string shift = GetShiftLabel(DateTime.Now);
                string conn = string.Empty;
                proc = "PRO_ESSENCORE_DASHBOARD_HOURLY_YIELD";
                conn = A4;
        ...
        public List<Dashboard_HourlyOP> getyieldDataOne(Dashboard_HourlyOP dashboard_HourlyOP)
        {
            ...
            try
            {
                ...
                string shift = GetShiftLabel(DateTime.Now);
                string conn = string.Empty;
                proc = "PRO_ESSENCORE_DASHBOARD_OUTPUT_COUNT";
                conn = A4;
        ...
        public List<Dashboard_HourlyOP> getfailtypevalue2(Dashboard_HourlyOP dashboard_HourlyOP)
        {
            List<Dashboard_HourlyOP> lstfailtypes = new List<Dashboard_HourlyOP>();
